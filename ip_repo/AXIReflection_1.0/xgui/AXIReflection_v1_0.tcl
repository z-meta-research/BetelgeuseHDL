...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "INITIAL_DELAY"
  ipgui::add_param $IPINST -name "INITIAL_SCALE"
  ipgui::add_param $IPINST -name "INITIAL_BYPASS"
  ipgui::add_param $IPINST -name "USE_URAM"
  ipgui::add_param $IPINST -name "C_AXI_STREAM_TDATA_WIDTH"
...
proc update_PARAM_VALUE.INITIAL_SCALE { PARAM_VALUE.INITIAL_SCALE } {
	# Procedure called to update INITIAL_SCALE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.INITIAL_SCALE { PARAM_VALUE.INITIAL_SCALE } {
	# Procedure called to validate INITIAL_SCALE
	return true
}
...
proc update_MODELPARAM_VALUE.INITIAL_SCALE { MODELPARAM_VALUE.INITIAL_SCALE PARAM_VALUE.INITIAL_SCALE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.INITIAL_SCALE}] ${MODELPARAM_VALUE.INITIAL_SCALE}
}
