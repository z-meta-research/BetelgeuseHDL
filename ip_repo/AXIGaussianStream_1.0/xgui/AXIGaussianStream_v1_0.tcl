...
proc update_PARAM_VALUE.N_RAND_STREAMS { PARAM_VALUE.N_RAND_STREAMS } {
	# Procedure called to update N_RAND_STREAMS when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.N_RAND_STREAMS { PARAM_VALUE.N_RAND_STREAMS } {
	# Procedure called to validate N_RAND_STREAMS
	return true
}
...
proc update_MODELPARAM_VALUE.N_RAND_STREAMS { MODELPARAM_VALUE.N_RAND_STREAMS PARAM_VALUE.N_RAND_STREAMS } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.N_RAND_STREAMS}] ${MODELPARAM_VALUE.N_RAND_STREAMS}
}
